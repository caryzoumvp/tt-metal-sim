    ...
    *(in1_mcast_receiver_semaphore_addr_ptr) = VALID;
    ...
    for (uint32_t b = 0; b < batch; b++) {
        ...
        for (uint32_t block = 0; block < num_blocks; block++) {
            ...
            profile_mark(PHASE_READER_IN0_AFTER_READS_ISSUED, block);

            // Barrier! make sure the reads are done
            noc_async_read_barrier();
            profile_mark(PHASE_READER_IN0_AFTER_BARRIER, block);
            ...
            profile_mark(PHASE_READER_IN0_WAIT_RECEIVERS, block);
            ...
            profile_mark(PHASE_READER_IN0_AFTER_MCAST, block);
            ...
            profile_mark(PHASE_READER_IN1_AFTER_READS_ISSUED, block);

            // Barrier! make sure the reads are done
            noc_async_read_barrier();
            profile_mark(PHASE_READER_IN1_AFTER_BARRIER, block);
            ...
            profile_mark(PHASE_READER_IN1_WAIT_RECEIVERS, block);
            ...
            profile_mark(PHASE_READER_IN1_AFTER_MCAST, block);
