...
export TT_SIM_DEBUG=debug
unset TT_SIM_DEBUG

export TT_METAL_DISABLE_SFPLOADMACRO=1
unset TT_METAL_DISABLE_SFPLOADMACRO=1
export TT_METAL_DRAM_BACKED_CQ=1
unset TT_METAL_DRAM_BACKED_CQ
export TT_LLK_SFPI_TOOL_PATH=/workspaces/tensix/tt-metal/runtime/sfpi/compiler/bin
