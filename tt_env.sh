...
export LD_LIBRARY_PATH=/workspaces/tensix/tt-metal/build_Release/tt_metal:/workspaces/tensix/tt-metal/build_Release/ttnn:/workspaces/tensix/tt-metal/build_Release/lib:${LD_LIBRARY_PATH:-}

export TT_METAL_DEVICE_PROFILER=1
export TT_METAL_DEVICE_PROFILER_NOC_EVENTS=1
export TT_METAL_DEVICE_PROFILER_NOC_EVENTS_RPT_PATH=/workspaces/tensix/tt-metal/profiler_out
